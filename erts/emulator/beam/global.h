...
struct port {
  ...
  // Binary *trace_filter;      /*Added by HL*/
...
void erts_change_default_trace_filter(Binary **trace_filter); /*Added by HL*/
void erts_get_default_trace_filter(Binary **trace_filter); /* Added by HL*/
